...
export const categories: Category[] = [
  ...
  },
  {
    ...
    value: "git",
    classlabel:
      "border-red-300 bg-red-200/10 text-red-900 dark:border-red-400/15 dark:bg-red-800/5 dark:text-red-200",
  },
  {
    label: "Inspiration",
    value: "inspiration",
    classlabel:
      "border-pink-300 bg-pink-200/10 text-pink-900 dark:border-pink-400/15 dark:bg-pink-800/5 dark:text-pink-200",
  },
]
